package ir.ac.kntu.model.gameplay.stomach.cell.pill;
...
public class YellowPill extends SingleCell {
    private final ImagePattern yellowPill = new ImagePattern(new Image("images/stomach/yellowPill.png"));

    public YellowPill(Stomach stomach, int rowIndex, int columnIndex) {
