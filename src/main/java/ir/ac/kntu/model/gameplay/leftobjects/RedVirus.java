...
public class RedVirus implements Drawable {
    private final ImagePattern shaking1 = new ImagePattern(new Image("images/viruses/RedVirusShaking1.png"));

    private final ImagePattern shaking2 = new ImagePattern(new Image("images/viruses/RedVirusShaking2.png"));

    private final ImagePattern laughing1 = new ImagePattern(new Image("images/viruses/RedVirusLaughing1.png"));

    private final ImagePattern laughing2 = new ImagePattern(new Image("images/viruses/RedVirusLaughing2.png"));

    private final ImagePattern die1 = new ImagePattern(new Image("images/viruses/RedVirusDie1.png"));

    private final ImagePattern die2 = new ImagePattern(new Image("images/viruses/RedVirusDie2.png"));
    ...
    public RedVirus(int startX, int startY, Status status) {
        this.startX = startX;
        this.startY = startY;
        this.status = status;
