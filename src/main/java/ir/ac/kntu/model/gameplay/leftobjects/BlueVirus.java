package ir.ac.kntu.model.gameplay.leftobjects;
...
public class BlueVirus implements Drawable {
    private final ImagePattern shaking1 = new ImagePattern(new Image("images/viruses/BlueVirusShaking1.png"));

    private final ImagePattern shaking2 = new ImagePattern(new Image("images/viruses/BlueVirusShaking2.png"));

    private final ImagePattern laughing1 = new ImagePattern(new Image("images/viruses/BlueVirusLaughing1.png"));

    private final ImagePattern laughing2 = new ImagePattern(new Image("images/viruses/BlueVirusLaughing2.png"));

    private final ImagePattern die1 = new ImagePattern(new Image("images/viruses/BlueVirusDie1.png"));

    private final ImagePattern die2 = new ImagePattern(new Image("images/viruses/BlueVirusDie2.png"));
    ...
    public BlueVirus(int startX, int startY, Status status) {
        this.startX = startX;
        this.startY = startY;
        this.status = status;
